        ...
        <div class="main-body">
            ...
            <div class="main-body-right" id="videoLists">
                <div class="main-body-right-left">
                    <form class="form-horizontal" method="post" action="/list" id="list_form"
                          enctype="multipart/form-data">

                        <input name="head_img" type="hidden" value="/image/list-top-bg.png">
                        <input name="foot_img" type="hidden" value="/image/list-bottom-bg.png">
                        <input type="hidden" name="item_color" id="item_color" value="#022049">
                        <input type="hidden" name="background_color" id="background_color" value="#033e86">
                        ...
                        <div class="main-body-right-left-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="col-sm-6">
                                        <div id="back-color" style="width:80px;height:80px;background:#033c86;"></div>
                                    </div>
                                    <div class="col-sm-6">
                                        <span class="col-sm-4" style="font-weight:600">色块颜色</span>
                                        <div class="col-sm-8" id="block-color" style="width:80px;height:80px;background:#022049;"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="col-sm-12 posr" style="padding: 0;">
                                        <img id="top-img" src="/image/list-top-bg.png" width="100%" height="300px" alt="">
                                        <label for="top-img-upload" class="posa img-mask"></label>
                                        <input onchange="preview(this,'top-img')" name="head_img_file" type="file"
                                               style="display: none;" id="top-img-upload" value="/image/list-top-bg.png">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <p>建议宽高750*200px</p>
                                    <div class="col-sm-12 posr" style="padding: 0;">
                                        <img id="bottom-img" src="/image/list-bottom-bg.png" width="100%" height="200px"
                                             alt="">
                                        ...
                                        <input onchange="preview(this,'bottom-img')" name="foot_img_file" type="file"
                                               style="display: none;" id="bottom-img-upload" value="/image/list-bottom-bg.png">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="main-body-right-right">
                    <div class="body-right-body">
                        ...
                        <div class="mobile" style="background:url(/image/mobile.png) left top no-repeat">
                            <div class="preview-box" style="background:#033c86">
                                <img id="top" src="/image/list-top-bg.png" width="100%" alt="">
                                ...
                                <img id="bottom" src="/image/list-bottom-bg.png" width="100%" alt="">
